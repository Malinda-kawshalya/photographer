  ...
  return (
    <div className="min-h-screen flex flex-col bg-gradient-to-b from-gray-50 to-white">
      ...
      <div className="container mx-auto px-4 py-12 flex-grow">
            ...
            <>
              ...
              {user?.role === 'client' && (
                <div className="flex justify-center mt-3 mb-4">
                  <StartChat userId={products[0].userId} type="shop" />
                </div>
              )}
            </>
          )}
        ...
        {error && (
          <div className="mb-8 p-4 bg-red-100 border border-red-400 text-red-700 rounded-lg text-center">{error}</div>
        )}
                  ...
                  <div className="relative w-full h-64">
                    ...
                    <span
                      className={`absolute top-3 left-3 px-3 py-1 rounded-full text-xs font-bold text-white ${
                        product.tag === 'BESTSELLER' ? 'bg-red-500' : 'bg-purple-500'
                      }`}
                    >
                      {product.tag}
                    </span>
        ...
        <div className="mt-16 bg-gradient-to-r from-blue-50 to-purple-50 rounded-xl p-8 text-center border border-blue-100">
          ...
          {user?.role === 'client' && products.length > 0 && (
            <StartChat userId={products[0].userId} type="shop" />
          )}
        </div>
      </div>
