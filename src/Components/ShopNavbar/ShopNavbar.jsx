    ...
    <div>
      <header className="bg-gradient-to-r from-[#850FFD] to-[#DF10FD]  rounded py-4 px-6 shadow-sm ">
        <div className="container flex items-center justify-between mx-auto">
          <Link to='/' className='flex'><img src="icon.png" alt="" className='flex w-6 mr-3 h-7' /><div className="text-xl font-bold text-white ">PHOTOGRAPHER.LK [Shop]</div>
          </Link>
        ...
        {isMobileMenuOpen && (
          <div className="px-6 py-4 bg-white shadow-md md:hidden">
            <nav className="flex flex-col space-y-4">
              <Link to='/shopdashboard' className="transition hover:text-purple" onClick={toggleMobileMenu}>Dashboard</Link>
              <Link to='/shoporder' className="transition hover:text-purple" onClick={toggleMobileMenu}>Order</Link>
              <Link to='/shopcard' className="transition hover:text-purple" onClick={toggleMobileMenu}>Shop Card</Link>
              <Link to='/shopearning' className="transition hover:text-purple" onClick={toggleMobileMenu}>Earnings</Link>
              <Link to='/shopnotice' className="transition hover:text-purple" onClick={toggleMobileMenu}>Notice</Link>
              <Link to='/shopabout' className="transition hover:text-purple" onClick={toggleMobileMenu}>About Us</Link>
