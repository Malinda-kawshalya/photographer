      ...
      <header className="bg-gradient-to-r from-[#850FFD] to-[#DF10FD] rounded py-4 px-6 shadow-sm">
        <div className="container mx-auto flex justify-between items-center">
          <Link to="/" className="flex items-center">
            ...
            <div className="text-xl font-bold text-white">PHOTOGRAPHER.LK [Rent]</div>
          </Link>

          {/* Desktop Navigation */}
          <nav className="hidden md:flex items-center space-x-6">
            <Link to="/rentdashboard" className="hover:text-purple-950 text-white transition">Dashboard</Link>
            <Link to="/rentorder" className="hover:text-purple-950 text-white transition">Orders</Link>
            <Link to="/rentcard" className="hover:text-purple-950 text-white transition">Rent Card</Link>
            <Link to="/rentearning" className="hover:text-purple-950 text-white transition">Earnings</Link>
            <Link to="/rentnotice" className="hover:text-purple-950 text-white transition">Notice</Link>
            <Link to="/rentabout" className="hover:text-purple-950 text-white transition">About Us</Link>
          </nav>
