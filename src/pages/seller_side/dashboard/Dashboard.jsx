            ...
            <div className='flex flex-col md:flex-row gap-8'>
                ...
                <div className='w-full md:w-2/3 space-y-8 '>
                    ...
                    <div className='flex flex-col space-y-6 '>
                        <Link to="/order"><div className='glass border border-gray-300 rounded-lg p-6 shadow-sm hover:shadow-lg transition-shadow '>
                        ...
                        <Link to="/notice"><div className='glass border border-gray-300 rounded-lg p-6 shadow-sm hover:shadow-lg transition-shadow '>
                        ...
                        <Link to="/earning"><div className='glass border border-gray-300 rounded-lg p-6 shadow-sm hover:shadow-lg transition-shadow '>
                            <h2 className='text-xl  font-bold mb-2'>Earning</h2>
                            <p className='text-gray-600'>Track your revenue and payment history.</p>
                        </div></Link>

                        <Link to="/Portfoliodetailsform"><div className='glass border border-gray-300 rounded-lg p-6 shadow-sm hover:shadow-lg transition-shadow '>
                ...
                <div className='w-full md:w-1/3'>
                    <div className='border glass border-gray-300 rounded-lg p-6 shadow-sm hover:shadow-lg transition-shadow '>
                        ...
                        <div className='border-t border-purple-400 pt-4 mb-6' >
                            <h3 className='font-bold mb-2'>My level - level 2</h3>
